                  ...
                  <div class="row mt-20">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label>Nom</label>
                            <input type="text" id="slug-source" name="name" class="form-control input-lg" value="{{ $commune->name }}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Slug</label>
                            <input type="text" name="slug" id="slug-target" class="form-control input-lg" value="{{ $commune->slug }}" required readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="tags" class="form-control input-lg tags" value="{{ $commune->tags }}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <input type="hidden" class="form-control" id='profile' name='image' readonly value="{{ $commune->image }}">
