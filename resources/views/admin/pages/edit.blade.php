...
@section('body')
    <div class="page-heading">
        <div class="buttons">
            ...
            <a href="/{{ $page->slug }}" class="btn btn-lg btn-green" target="_blank">
    ...
    <section class="mt-20">
        <div class="container-fluid">
            ...
            {!! Form::model($page, ['method' => 'PATCH', 'route' => ['pages.update', $page->id], 'class' => '_form' ]) !!}
            {{-- Left side  --}}
            <div class="row">
                <div class="col-sm-8">
                    <div class="block">
                        ...
                        <div class="block-content">
                            <div class="form-group">
                                {!! Form::select('status',
                                    ...
                                    $page->status, ['class' => 'form-control input-lg']) !!}
                            </div>
