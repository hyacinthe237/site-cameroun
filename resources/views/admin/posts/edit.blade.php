...
@section('body')
    <div class="page-heading">
        <div class="buttons">
            ...
            <a href="/offers/{{ $post->slug }}" class="btn btn-lg btn-success" target="_blank">
    ...
    <section class="mt-20">
        <div class="container-fluid">
            ...
            {!! Form::model($post, ['method' => 'PATCH', 'route' => ['posts.update', $post->id], 'class' => '_form' ]) !!}
            {{-- Left side  --}}
            <div class="row">
                <div class="col-sm-8">
                    <div class="block">
                ...
                <div class="col-sm-4">
                        ...
                        <div class="block-content">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('status',
                                    ...
                                    $post->status, ['class' => 'form-control input-lg']) !!}
                            </div>

                            <h4 class="mt-20">Image Preview</h4>
                    ...
                    <div class="mt-20">
                        <button type="submit" name="submit" class="btn btn-lg btn-wise btn-block">
                            <i class="ion-checkmark"></i> Update Page
                        </button>
                    </div>
                </div>
                {{-- End of col 3 --}}
